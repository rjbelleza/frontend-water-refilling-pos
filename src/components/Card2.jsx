    ...
    return (
        <>
            {products ? products.map(product => (
                <div className="flex flex-col gap-2 h-fit w-[220px] p-6 bg-white rounded-sm shadow-md shadow-gray-500 
                                border-1 border-gray-500 border-t-8 border-t-blue-400"
                     key={product.id}
                >
