  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        accessorKey: 'date',
        header: 'Date',
        cell: info => format(parseISO(info.getValue()), "MMMM d, yyyy"),
        size: 290,
      },
      {
      ...
      },
      {
        ...
        cell: info => {
          ...
          const income = row.total_sales - row.total_expenses;
          return `${income.toLocaleString('en-PH', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`;
        },
        size: 290,
      },
    ],
    ...
    <div className="w-full">
      ...
      <div className="flex flex-col w-full sm:flex-row gap-2">
        <div className='flex justify-between w-full gap-20 border border-gray-300 p-3 pl-5 rounded-2xl mb-4'>
          <div className='text-[23px] font-medium text-sky-800 w-[200px]'>Reports List</div>
